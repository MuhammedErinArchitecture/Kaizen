namespace ConsoleApp2
{
    ...
    public class Program
    {
        ...
        {
            var check = 0;
            // JSON verisini burada girdi olarak alıyoruz.
            string jsonString = @"[
   {
      ""locale"":""tr"",
   ...
   },
   {
      ...
      ""boundingPoly"":{
         ""vertices"":[
            ...
            List<(int x, int y, string description)> points = new List<(int x, int y, string description)>();

            foreach (var item in jsonArray)
            {
                int x = item["boundingPoly"]["vertices"][0]["x"].Value<int>();
                int y = item["boundingPoly"]["vertices"][0]["y"].Value<int>();
                string description = item["description"].Value<string>();
                points.Add((x, y, description));
            }
